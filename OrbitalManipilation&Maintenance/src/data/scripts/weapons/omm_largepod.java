...
public class omm_largepod implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (this.SHIP.getOriginalOwner() == 0 || this.SHIP.getOriginalOwner() == 1) { //check for refit screen
            ...
            for (FighterWingAPI fighterWingAPI : dronewings) {
                if (!fighterWingAPI.getWingId().equals("omm_largepod_wing")) {   //name is the built-in drone wing
                    continue;
                }
            ...
            if (this.SHIP != null) {
                ...
                for (FighterWingAPI fighterWingAPI : list1) {
...

                    {
                        ...
                        if (this.SHIP.getVariant().getWeaponSpec("largeslot") != null) {
                            mutableShipStatsAPI.getVariant().addWeapon("largeslot", this.SHIP.getVariant().getWeaponId("largeslot"));
