...
public class omm_synergypod implements EveryFrameWeaponEffectPlugin {
            ...
            if (this.SHIP != null) {
                ...
                for (FighterWingAPI fighterWingAPI : list1) {
...

                    {
                        ...
                        if (this.SHIP.getVariant().getWeaponSpec("synergyslot") != null) {
                            mutableShipStatsAPI.getVariant().addWeapon("synergyslot", this.SHIP.getVariant().getWeaponId("synergyslot"));
