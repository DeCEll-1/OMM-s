...
public class MissionDefinition implements MissionDefinitionPlugin {
    ...
    public void defineMission(MissionDefinitionAPI api) {
        ...
        api.addToFleet(FleetSide.PLAYER, "omm_euphausia_militarized", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_crevette_militarized", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_ecrevisse_militarized", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_euphausia_militarized", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_sesarma_militarized", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_sesarma_militarized", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_sesarma_militarized", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_nathantia_militarized", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_sandhopper_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_sandhopper_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "omm_limnopilos_militarized", FleetMemberType.SHIP, true);
        ...
        api.addToFleet(FleetSide.ENEMY, "aurora_Assault_Support", FleetMemberType.SHIP, false);
